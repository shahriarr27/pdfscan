                        ...
                        <tr>
                            <td class="wrapper">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <p>Hi {{ $details['customer']['first_name'] }} {{ $details['customer']['last_name'] }},</p>
                                            <p>Thank you so much for the order</p>
                                                            ...
                                                            <table role="presentation" border="0" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                    <tr style="margin-bottom: 16px">
                                                                        <td style="min-width: 90px">First Name </td>
                                                                    ...
                                                                    <tr style="margin-bottom: 16px">
                                                                        <td>Company </td>
                                                                        <td>{{ $details['customer']['company'] }}</td>
                                                                    </tr>
                                                                    <tr style="margin-bottom: 16px">
                                                                        <td>Address </td>
                                                        ...
                                                        <table role="presentation" border="0" cellpadding="0"
                                                            ...
                                                            <tbody>
                                                                <tr style="margin-bottom: 16px">
                                                                    ...
                                                                    <td>{{ $details['order']['price'] }}
                                                                    </td>
                                                                </tr>
                                                                <tr style="margin-bottom: 16px">
                                                                    <td>Date </td>
                                                                    <td>{{ $details['order']['created_at'] }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </td>
                                        ...
                                        <p style="margin-top: 20px">We will reach to you soon</p>
                                        <p style="margin-top: 0px">Thank you so much</p>
                                        </td>
                                      </tr>
                                  </table>
